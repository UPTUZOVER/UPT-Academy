...
class Course(models.Model):
    ...
    pupil_number = models.PositiveSmallIntegerField(
    ...
    total_money = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        verbose_name=_("Total Money")
    )
    start_cource = models.DateField(
        verbose_name=_("Start Date")
    )
    end_cource = models.DateField(
...
class Check_Pupil(models.Model):
    parent = models.OneToOneField(Pupil, on_delete=models.CASCADE)
    pupil = models.ForeignKey(Pupil, on_delete=models.CASCADE)
    created_on = models.DateTimeField(auto_now_add=True, verbose_name=("Yaratilgan sana"))
    updated_on = models.DateTimeField(auto_now=True, verbose_name=("Yangilangan sana"))
